...
class NERPipeline:
    ...
    def __init__(
        ...
        self.tokenizer, self.model = with_ssl_fallback(
            lambda: (
                AutoTokenizer.from_pretrained(model_path, use_fast=False, **hf_kwargs),
                AutoModelForTokenClassification.from_pretrained(model_path, **hf_kwargs),
            ),
